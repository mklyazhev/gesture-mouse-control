...
class TrainClassifier:
                ...
                with tqdm(test_loader, unit="batch") as tepoch:
                    ...
                    for i, (images, labels) in enumerate(tepoch):
                        ...
                        for target in list(labels)[0].keys():
                            ...
                            # TODO: # из list of numpy.ndarrays очень медленно конвертится в тензор,
                            #  просит сначала сконвертить в np.ndarray
    ...
    def run_epoch(
        ...
        if writer is not None:
            ...
            add_params_to_tensorboard(writer, optimizer_params, epoch, "optimizer", {"params", "foreach"})
